...
bool rgxEvaluation(
	const std::basic_regex<char>& rgx,
	const std::string_view& str) {
...
ConditionBuilder& ConditionBuilder::setName(const std::string_view& name) {
	_name = std::optional<std::string>(name);
	return *this;
}

ConditionBuilder& ConditionBuilder::setName(const std::basic_regex<char>& rgx) {
	_rgxName = rgx;
	return *this;
}

ConditionBuilder& ConditionBuilder::setPath(const std::string_view& path) {
	_path = std::optional<std::string>(path);
	return *this;
}

ConditionBuilder& ConditionBuilder::setPath(const std::basic_regex<char>& rgx) {
	_rgxPath = rgx;
	return *this;
}
